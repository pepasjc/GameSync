...
object InstalledRomsScanner {
    ...
    val SYSTEM_ROM_DIRS: Map<String, List<String>> = linkedMapOf(
        // Sony
        "PS1"    to listOf("psx", "PSX", "PS1", "ps1", "PlayStation", "playstation", "PlayStation 1"),
        "PS2"    to listOf("ps2", "PS2", "PlayStation 2", "PlayStation2"),
        "PS3"    to listOf("ps3", "PS3", "PlayStation 3", "PlayStation3"),
        "PSP"    to listOf("psp", "PSP", "PlayStation Portable"),
        "VITA"   to listOf("psvita", "PSVITA", "Vita", "PS Vita"),
        // Nintendo
        "GBA"    to listOf("gba", "GBA", "Game Boy Advance", "GameBoyAdvance"),
        "GB"     to listOf("gb", "GB", "Game Boy", "GameBoy"),
        "GBC"    to listOf("gbc", "GBC", "Game Boy Color", "GameBoyColor"),
        "NES"    to listOf("nes", "NES", "Nintendo", "Famicom"),
        "SNES"   to listOf("snes", "SNES", "Super Nintendo", "SuperNintendo"),
        ...
        "32X"    to listOf("sega32x", "32x", "32X", "Sega 32X"),
        // NEC / SNK / misc
        ...
        "NGPC"   to listOf("ngpc", "NGPC", "Neo Geo Pocket Color"),
        "WSWAN"  to listOf("wonderswan", "WSWAN", "WonderSwan"),
        "WSWANC" to listOf("wonderswancolor", "WSWANC", "WonderSwan Color", "WonderSwanColor"),
        // Atari
        "A2600"  to listOf("atari2600", "A2600", "Atari 2600"),
        "A5200"  to listOf("atari5200", "A5200", "Atari 5200"),
        "A7800"  to listOf("atari7800", "A7800", "Atari 7800"),
        "A800"   to listOf("atari800", "A800", "Atari 800"),
        "LYNX"   to listOf("lynx", "Lynx", "Atari Lynx"),
        "JAGUAR" to listOf("jaguar", "Jaguar", "Atari Jaguar"),
        // Misc
        "3DO"    to listOf("3do", "3DO"),
        "POKEMINI" to listOf("pokemini", "Pokemon Mini", "PokemonMini"),
        // Arcade: MAME is its own system on the server (``/api/v1/roms`` emits
        // ``system=MAME`` for ZIPs under ``<rom_dir>/mame/``).  Keep the
        // ARCADE entry as a catch-all for mixed arcade libraries — the
        // first-match-wins candidate search means a user with a single
        // ``arcade/`` folder gets MAME downloads funneled there, while a
        // dedicated ``mame/`` folder keeps them separate.
        "MAME"   to listOf("mame", "MAME", "arcade", "Arcade"),
