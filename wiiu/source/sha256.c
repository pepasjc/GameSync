// SHA-256 (FIPS 180-4) - based on Brad Conte's public-domain implementation,
// same code shared with the 3DS / NDS / PS3 clients. Pure C, no platform
// dependencies, endian-safe.
...
void sha256_final(SHA256_CTX *ctx, uint8_t hash[32])
{
    ...
    size_t   pad_idx = (size_t)(ctx->count % 64);
