"""Shared ROM-based title ID helpers for Python components.

This module is the single source of truth for ROM filename normalization and
emulator-style title IDs such as ``GBA_advance_wars_usa``.
"""
