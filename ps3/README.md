...
This folder contains the native PS3 GameSync client.
...
- upload/download saves from the GameSync server
...
The GameSync client should assume Apollo is installed and use Apollo-compatible
...
The package artwork lives at `assets/ICON0.PNG` and is generated by
`assets/generate_icon0.py`.
